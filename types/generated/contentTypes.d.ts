...
export interface ApiLoreSectionLoreSection extends Struct.CollectionTypeSchema {
  collectionName: 'lore_sections';
  info: {
    description: '';
    displayName: 'Lore Section';
    pluralName: 'lore-sections';
    singularName: 'lore-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lore-section.lore-section'
    > &
      Schema.Attribute.Private;
    mainSection: Schema.Attribute.String & Schema.Attribute.Required;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiRuleSectionRuleSection extends Struct.CollectionTypeSchema {
  collectionName: 'rule_sections';
  info: {
    description: '';
    displayName: 'Rule Section';
    pluralName: 'rule-sections';
    singularName: 'rule-section';
  };
  options: {
    draftAndPublish: true;
  };
